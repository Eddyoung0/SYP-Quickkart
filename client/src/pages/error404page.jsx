...
const error404page = () => {
  return (
   ...
   <div className='w-auto h-screen rounded-lg p-4 flex flex-col items-center justify-center'>
    ...
    <h2 className='text-md sm:text-xl md:text-2xl lg:text-3xl font-[600] mb-3 tracking-wide'>Oops, we nearly lost you</h2>
    <h2 className='text-sm md:text-lg lg:text-xl font-[300]'>let's get you back to where you are suppossed to be</h2>
